...
def run_tests():
    ...
    assert(powermake.version_parser.parse_version("prerelease-2.0.22") == powermake.version_parser.Version(epoch="1", release=("2", "0", "22"), pre_type=powermake.version_parser.PreType.ALPHA, pre_number='1'))
