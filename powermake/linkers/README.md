...
If your linker inherits from `powermake.linkers.LinkerGNU`, you may want to put your linker in `gnu.py`, idem if your linker inherits from `powermake.linkers.LinkerMSVC`.
