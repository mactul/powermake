...
def run_callbacks(config: Config, *, build_callback: Callable[[Config], None], clean_callback: Callable[[Config], None] = default_on_clean, install_callback: Callable[[Config, T.Union[str, None]], None] = default_on_install) -> None:
...
def run(target_name: str, *, build_callback: Callable[[Config], None], clean_callback: Callable[[Config], None] = default_on_clean, install_callback: Callable[[Config, T.Union[str, None]], None] = default_on_install, args_parsed: T.Union[argparse.Namespace, None] = None) -> None:
