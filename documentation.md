...
Let's assume a file structure like this:
```
- folder1
    - folder11
        - file111.cpp
...
print(powermake.get_files("*.c"))
# >>> {'file1.c', 'file2.c'}

print(powermake.get_files('*'))
# >>> {'folder1', 'folder2', 'folder3', 'file1.c', 'file2.c', 'file3.cpp', 'makefile.py'}

print(powermake.get_files('*.c', '*.cpp'))
# >>> {'file1.c', 'file2.c', 'file3.cpp'}

print(powermake.get_files('**/*.c'))
# >>> {'file1.c', 'file2.c', 'folder1/folder11/file112.c', 'folder1/folder12/file121.c', 'folder2/folder21/file211.c', 'folder3/file31.c', 'folder3/folder31/file312.c', 'folder3/folder33/file331.c'}


print(powermake.get_files("folder1/**/*.c", "folder1/**/*.cpp"))
# >>> {'folder1/file11.cpp', 'folder1/folder11/file111.cpp', 'folder1/folder11/file112.c', 'folder1/folder12/file121.c'}

print(powermake.get_files('**1/*11*.c*'))
# >>> {'folder1/file11.cpp', 'folder1/folder11/file111.c'}
```
