...
Everything comes down to a single command:
...
Once all that is set up, you will be able to put a breakpoint in your main.c file using F9 and then debug your program using F5.
